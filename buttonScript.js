...
function ShowStates() {
  ...
  document.getElementById("content").innerHTML = "<table class='table-responsive-md table table-striped table-success'>"+
"  <thead>"+
"    <tr>"+
...
"    </tr>"+
"    <tr>"+
"      <td><img src='state_icons\frenzy.png' class='img-fluid'></td>"+
"      <td>Frenzied State</td>"+
"      <td>Attack of Characters in this state x 2 additionally.</td>"+
"    </tr>"+
"    <tr>"+
"      <td><img src='state_icons\fervent.png' class='img-fluid'></td>"+
"      <td>Fervent State</td>"+
"      <td>"+
...
"    </tr>"+
"    <tr>"+
"      <td><img src='state_icons\blessed.png' class='img-fluid'></td>"+
"      <td>Blessed State</td>"+
...
"</table>"+
""+
"<table class='table-responsive-md table table-striped table-danger'>"+
"  <thead>"+
"    <tr>"+
"      <th scope='col' colspan='3'>"+
...
"  <tbody>"+
"    <tr>"+
"      <td><img src='state_icons\fatigue.png' class='img-fluid'></td>"+
"      <td>Fatigue State</td>"+
"      <td>"+
